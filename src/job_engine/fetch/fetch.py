...
Browser-shaped fetching (cloakbrowser) is deliberately *not* part of
this interface — a rendered-page workflow shares no request/response
semantics with JSON APIs. See
:mod:`job_engine.fetch.scrapers._cloakbrowser`.
...
from job_engine.fetch.exceptions import CompanyNotFoundError, ScraperError
